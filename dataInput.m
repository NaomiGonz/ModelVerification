...
ry1 = input('Which joint has a reaction force y1: ');
ry2 = input('Which joint has a reaction force y2: ');
Sy(ry1,2) = 1;
Sy(ry2,3) = 1;
...
save('TrussPracticeDesign_NaomiLakshmiIsha_A1.mat','C','Sx','Sy','X','Y','L');